...
// Created: 5/5/2011 3:24:55 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsaz1u4r000000gc0tp84hfa_5z1i";
	this.domain="wt.proquest.com";
	this.timezone=-5;
	this.fpcdom="";
	this.onsitedoms="";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,docx,xlsx,swf,html,rtf,pdf";
